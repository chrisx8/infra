...
Once you activate the virtualenv with `./activate`, some helper shell functions will be available.

Available shell functions:

- `anplay`: run `ansible-playbook` with pre-supplied args.
- `anvault`: create/edit Ansible Vault files.
